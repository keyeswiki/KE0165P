...
1\. 确保Arduino主控板与计算机连接成功，然后双击 “**KidsBlock**” 图标![Img](../img/kidsblock.png)打开KidsBlock软件。
...
3\. 由于本教程使用的是 4WD Robot Car V2.0 Kit for Arduino 设备，所以选择 “**4WD Robot Car V2.0 Kit for Arduino**” 设备，如下图所示：
...
![Img](../img/Equip-9-1.png)

代码编写完成后保存到电脑，单击 “**文件**” --> “**保存到电脑**”，如下图所示：

![Img](../img/Equip-10.png)

![Img](../img/Equip-10-1.png)

单击![Img](../img/upload.png)将代码上传到Arduino主控板。
